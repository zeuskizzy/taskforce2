...
class BannersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create banner" do
    assert_difference('Banner.count') do
      post banners_url, params: { banner: { bannerimg: @banner.bannerimg, slug: @banner.slug, sub_title: @banner.sub_title, title: @banner.title } }
    end
  ...
  test "should update banner" do
    patch banner_url(@banner), params: { banner: { bannerimg: @banner.bannerimg, slug: @banner.slug, sub_title: @banner.sub_title, title: @banner.title } }
