...
class FaqsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faq" do
    assert_difference('Faq.count') do
      post faqs_url, params: { faq: { body: @faq.body, slug: @faq.slug, sub_title: @faq.sub_title, title: @faq.title } }
    end
  ...
  test "should update faq" do
    patch faq_url(@faq), params: { faq: { body: @faq.body, slug: @faq.slug, sub_title: @faq.sub_title, title: @faq.title } }
